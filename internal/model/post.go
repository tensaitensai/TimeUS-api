...
type Post struct {
	...
	Subjectstarttime time.Time `json:"subjectstarttime" gorm:"column:subjectstarttime;type:DATETIME(6)"`
	Subjectendtime   time.Time `json:"subjectendtime" gorm:"column:subjectendtime;type:DATETIME(6)"`
}
